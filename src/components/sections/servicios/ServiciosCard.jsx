export function ServiceCard({ icon, title, description }) {
    return (
        <article className="group bg-gradient-to-br from-white to-surface-soft border border-gray-200 rounded-2xl shadow-sm hover:shadow-xl hover:shadow-brand-500/15  hover:-translate-y-1 
            ...
            <div className="flex flex-col gap-2">
                <h3 className="font-bold text-xl text-text group-hover:text-brand-500 transition-colors duration-300">
                    {title}
                </h3>
